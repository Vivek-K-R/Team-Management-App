...
class _TaskViewPageState extends State<TaskViewPage> {
  ...
  // Function to get user's UID field from users collection
  Future<String?> getUserIdFromMemberId(String memberId) async {
    try {
      ...
      if (userDoc.exists) {
        // Get the value of the 'uid' field from the document
        Map<String, dynamic> userData = userDoc.data() as Map<String, dynamic>;
        String? userId = userData['uid'] as String?; // Get the uid field value
        return userId;
      }
      return null;
    } catch (e) {
